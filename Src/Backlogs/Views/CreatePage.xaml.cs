...
namespace Backlogs.Views
{
    ...
    public sealed partial class CreatePage : Page
    {
        ...
        /// <summary>
        /// Validate user input and proceed to create the Backlogs
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private async void CreateButton_Click(object sender, RoutedEventArgs e)
        {
           try
            {
                await Logger.Info("Creating Backlogs.....");
                Debug.WriteLine("[i] Creating Backlogs.....");
            ...
            catch (Exception ex)
            {
                ...
                await Logger.Error("Failed to create Backlogs", ex);
                Debug.WriteLine("[ex] Failed to create Backlogs" + ex.Message);
            }
        }

        /// <summary>
        /// Search for the Backlogs metadata
        /// </summary>
        ...
        private async Task SearchFilmBacklog(string title, string date, TimeSpan time)
        {
            try
            {
                ...
                if(filmResult.results.Length > 0)
                {
                    ...
                    await Logger.Info("Succesfully created Backlogs");
                    Debug.WriteLine("[i] Succesfully created Backlogs");
                }
                else
                {
