...
namespace Backlogs.Views
{
    ...
    public sealed partial class BacklogPage : Page
    {
        ...
        {
            await Logger.Info("Deleting Backlogs.....");
            Debug.WriteLine("[i] Deleting Backlogs.....");

            ContentDialog deleteDialog = new ContentDialog
            {
                Title = "Delete Backlogs?",
                Content = "Deletion is permanent. This Backlogs cannot be recovered, and will be gone forever.",
        ...
        /// <summary>
        /// Delete a Backlogs after confirmation
        /// </summary>
        ...
        /// <summary>
        /// Write Backlogs to the json file locally and on OneDrive if signed-in
        /// </summary>
        /// <returns></returns>
        private async Task SaveBacklog()
        {
            await Logger.Info("Saving Backlogs....");
            Debug.WriteLine("[i] Saving Backlogs....");
        ...
        {
            await Logger.Info("Marking Backlogs as complete");
            Debug.WriteLine("[i] Marking Backlogs as complete");
        ...
        private async void DataTransferManager_DataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            ...
            dataRequest.Data.Properties.Title = $"Share {backlog.Name} Backlogs";
            dataRequest.Data.Properties.Description = "Your contacts with the Backlogs app installed can open this file and add it to their Backlogs";
